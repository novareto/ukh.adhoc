...
zczve1aa = Table(config['zczve1aa'], metadata, schema="EDUCUSADAT", autoload=True, autoload_with=engine)
zckto1aa = Table(config['zckto1aa'], metadata, schema="EDUCUSADAT", autoload=True, autoload_with=engine)
